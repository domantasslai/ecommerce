...
@endif
    ...
    <div class="media-body">
        <h5 class="mt-0 mb-1">{{ $comment->commenter->name ?? $comment->guest_name }} <span class="Stars px-3" style="--rating: {{ $comment->rating }};" aria-label="Rating of this product is 2.3 out of 5."></span> <small class="text-muted"> {{ $comment->created_at->diffForHumans() }}</small></h5>
