  ...
  <div class="auth-pages">
    <div class="auth-left">
      ...
      <form action="{{ route('login') }}" method="post">
        @csrf
        <input type="email" id="email" name="email" value="{{ old('email') }}" required placeholder="Email" autofocus>
        <input type="password" id="password" name="password" value="{{ old('password') }}" required placeholder="Password" autofocus>
        <div class="login-container">
          <button type="submint" class="auth-button">Login</button>
